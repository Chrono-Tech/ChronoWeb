...
(function () {
	...
	var Swiper = function (container, params) {
		...
		if (s.params.pagination) {
			...
			if (s.params.paginationWrapper) {
				s.paginationWrapper = $(s.params.paginationWrapper);
			}
		}
		// Next/Prev Buttons
		...
		s.updateProgress = function (translate) {
			...
			var wasEnd = s.isEnd;
			if (s.translatesDiff !== translatesDiff) {
				s.translatesDiff = translatesDiff;
				s.emit('onDiffChange', s);
			}
			if (translatesDiff === 0) {
				s.progress = 0;
		...
		s.updatePagination = function () {
			...
			if (s.paginationContainer && s.paginationContainer.length > 0) {
				...
				if (s.params.paginationType === 'bullets') {
					...
					if (s.paginationLine) {
						paginationHTML += '<span class="swiper-filling-line"></span>';
					}
					if (s.paginationWrapper) {
						console.log('wrapper');
						s.paginationWrapper.html(paginationHTML);
						s.paginationContainer.append(s.paginationWrapper)
					} else {
		...
		s.setWrapperTransition = function (duration, byController) {
			...
			s.paginationWrapper.transition(duration);
		...
		s.setWrapperTranslate = function (translate, updateActiveIndex, byController) {
			...
			if (!s.params.virtualTranslate) {
				...
				//else
					...
					s.paginationWrapper.transform('translate(' + x + 'px, ' + y + 'px)');
			}
